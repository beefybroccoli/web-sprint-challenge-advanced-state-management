...
### Complete actions/index.js
  ...
  * [x] Add a thunk action called fetchSmurfs that triggers a loading status display in our application, performs an axios call to retriive all smurfs from the api. Save the result of to our state and show an error if one is made.
